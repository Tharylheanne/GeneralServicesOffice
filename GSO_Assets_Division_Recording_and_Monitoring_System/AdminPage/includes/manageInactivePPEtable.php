<?php 
 ...
 <tr>
    ...
    <td><?php echo isset($rows["AREno"]) ? $rows["AREno"] : ''; ?></td>
    ...
    <td>
      <a href="manageActivePPEeditTable.php?propertyID=<?php echo $rows['propertyID']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
    </td>
 </tr>
