  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Property Return Slip (PRS)</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-dashboard">Property Return Slip</i></a></li>
        </ol>
      </section>

      <!-- Main Content -->
      <section class="content container-fluid">
        <a href="addPRS.php" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i>&nbsp Add PRS</a>

        <br><br>
        <section class="">
            <form enctype="multipart/form-data" method="POST" action="importPRSdata.php">
                <input type="file" name="file" id="file" accept=".xlsx, .xls"><br>
                <button type="submit" name="importPRS" class="btn btn-primary" id="importPRS">IMPORT</button>
            </form>
        </section>
        ...
        <!-- import button -->
            ...
            <div class="box">
              <div class="box-header bg-blue" align="center">
                <h4 class="box-title">PROPERTY RETURN SLIP (PRS) MASTER LIST
              </div><!-- box header -->
              <br>
              <div class="table-responsive">
                <table id="PRS" class="table table-hover responsive" cellpadding="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th colspan="2">UPDATES/CURRENT STATUS</th>
                    ...
                    <tr>
                      ...
                      <th class="subcolumn" style="white-space: nowrap;">ARE NUMBER</th>
                  ...
                  <tbody>
                    <?php include("../AdminPage/managePRS.php")?>
                  </tbody>
                </table>
              </div>
            </div>
