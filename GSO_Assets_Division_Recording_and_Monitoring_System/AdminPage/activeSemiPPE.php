  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        <a href="ICS_registry.php" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i>&nbsp Add ICS Registry</a>
        ...
        <!-- import button -->
            ...
            <div class="box">
              ...
              <div class="table-responsive">
                <table id="activeSemi" class="table table-hover responsive" cellpadding="0" width="100%">
                  ...
                  <tbody>
                    <?php include("../AdminPage/includes/manageSemiExpendablePPE.php")?>
                  </tbody>
                </table>
              </div>
            </div>
