  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Inactive Property, Plant, and Equipments(PPE)</h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="fa fa-dashboard">Inactive PPE</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
            <div class="box">
              <div class="box-header bg-blue" align="center">
                <h4 class="box-title">LIST OF INACTIVE PROPERTY, PLANT AND EQUIPMENT
                  <small style="color: white;">     Items costing ₱50,000 and above</small></h4>
              </div><!-- box header -->
              <br>
              <div class="table-responsive">
                <table id="inactivePPE" class="table table-hover responsive" cellpadding="0" width="100%">
                  ...
                  <tbody>
                    <?php include("../AdminPage/includes/manageInactivePPEtable.php")?>
                  </tbody>
                </table>
              </div>
            </div>
    ...
    <!-- <script>
      $(document).ready(function() {
          ...
          var table = $('#inactivePPE').DataTable({
          ...
          $('#inactivePPE').on('dblclick', 'td', function() {
          ...
          $('#inactivePPE').on('blur', '.editable-cell', function() {
              var value = $(this).val();
