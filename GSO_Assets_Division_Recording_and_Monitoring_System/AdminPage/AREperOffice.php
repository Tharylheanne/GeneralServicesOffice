...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if (!empty($office)) {
            ...
            $OfficeArray[] = ['officeName' => $office, 'colorClass' => $randomColorClass];
        }
    }
}
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa archive"></i>Per Office/Department Report</h1>
        <ol class="breadcrumb">
          <li><a href="AREreports.php"><i class="fa fa-dashboard">ARE per Office/Department Report</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box box-primary">
          <div class=" box-header bg-blue text-center">
            <h4 class="box-title">ARE per Office/Department Report</h4>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <input type="text" name="officeSearch" id="officeSearch" class="form-control" placeholder="Search for an office/department ...">
                    </div><!-- form-group -->
                </div><!-- col-md-3 -->
            </div><!-- row -->
            <div class="row">
                <div class="col-md-12">
                    <?php foreach ($OfficeArray as $office) : ?>
                       <div class="col-md-4 office-box">
                         <a href="AREpropertiesByOffice.php?officeName=<?php echo urlencode($office['officeName']); ?>" class="box-link" target="_blank">
                           <div class="small-box <?php echo $office['colorClass']; ?>">
                               <div class="inner">
                                   <h4 class="office-name" align="center"><?php echo $office['officeName']; ?></h4>
                               </div>
                           </div>
                       </div>
                     <?php endforeach; ?>
    ...
    <script>
      $('#officeSearch').on('keyup', function(){
        ...
        $('.office-box').each(function(){
          var responsibilityCenter = $(this).find('.office-name').text().toLowerCase();
