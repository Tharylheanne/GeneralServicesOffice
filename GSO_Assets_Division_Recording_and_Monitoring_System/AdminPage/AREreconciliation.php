<div class="col-md-6 vertical-line">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" name="estimatedLife" class="form-control" id="estimatedLife" placeholder="Estimated Useful Life" name="estimatedLife" autocomplete="off" min="1">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="supplier" class="form-control" placeholder="Supplier" id="supplier" autocomplete="off" style="text-transform: uppercase;">
                  </div>
                </div>
                <!-- End Supplier -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea type="text" name="notes" class="form-control" placeholder="Notes" id="notes" autocomplete="off" style="resize: vertical; height: 2.4em;"></textarea>
                  </div>
                </div>
                <!-- End Notes -->
              </div><!-- col-md-6 -->