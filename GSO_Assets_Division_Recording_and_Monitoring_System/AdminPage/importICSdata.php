    ...
    if (isset($_FILES['file']['tmp_name']) && !empty($_FILES['file']['tmp_name'])) {
        ...
        if ($file_ext === 'xlsx' || $file_ext === 'xls') {
            ...
            if (move_uploaded_file($file_tmp, $destinationPath)) {
                ...
                $generalPropertiesColumns = ['B', 'C', 'D', 'E', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'S', 'T', 'X'];
                $areCsGenPropertiesColumns = ['A', 'P', 'Q', 'R', 'U', 'V', 'W', 'Y', 'Z', 'AA', 'AC'];
                ...
                $AreIcsGenPropertiesSql = "INSERT INTO are_ics_gen_properties (propertyID, dateReceived, onhandPerCount, soQty, soValue, previousCondition, location, currentCondition, supplier, POnumber, AIRNumber, jevNo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
