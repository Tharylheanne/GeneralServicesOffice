  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="AREreports.php"><i class="fa fa-dashboard">ARE per Account Code/Classification Report</i></a></li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
        <div class="box box-primary">
          <div class=" box-header bg-blue text-center">
            <h4 class="box-title">ARE per Account Code/Classification Report</h4>
          </div>
          <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <?php foreach ($accountNumberArray as $accountNumber) : ?>
                       <div class="col-md-4 account-box">
                         <a href="AREpropertiesByAccount.php?accountNumber=<?php echo urlencode($accountNumber['accountNumber']); ?>" class="box-link" target="_blank">
